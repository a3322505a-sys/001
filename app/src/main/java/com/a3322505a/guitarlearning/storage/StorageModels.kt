...
/** The deliberately small mastery vocabulary used by V0.2.0. */
...
data class Progress(
    ...
    /** The latest outcomes are retained for the small V0.2.0 mastery rule. */
...
/** Settings needed to construct the V0.2.0 question bank. */
data class Settings(
