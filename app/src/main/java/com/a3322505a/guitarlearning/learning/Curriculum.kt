...
object Curriculum {
    val nodes = listOf(
        ...
        CurriculumNode("p04", "3弦 G / A", Category.FRETBOARD, "继续扩展第一把位。", listOf("p03"), listOf(Coordinate(3, 0), Coordinate(3, 2)), false),
        CurriculumNode("p05", "跨弦 B / D", Category.FRETBOARD, "认识同音高的不同位置。", listOf("p04"), listOf(Coordinate(3, 4), Coordinate(4, 0)), false),
        CurriculumNode("p06", "4弦 E / F", Category.FRETBOARD, "用熟悉的半音关系认识新位置。", listOf("p05"), listOf(Coordinate(4, 2), Coordinate(4, 3)), false),
        CurriculumNode("p07", "5弦 A / B", Category.FRETBOARD, "增加第五根弦。", listOf("p06"), listOf(Coordinate(5, 0), Coordinate(5, 2)), false),
        CurriculumNode("p08", "加入 C / E", Category.FRETBOARD, "连接第5弦与第6弦。", listOf("p07"), listOf(Coordinate(5, 3), Coordinate(6, 0)), false),
        CurriculumNode("p09", "6弦 F / G", Category.FRETBOARD, "完成第一把位18个自然音位置。", listOf("p08"), listOf(Coordinate(6, 1), Coordinate(6, 3)), false),
