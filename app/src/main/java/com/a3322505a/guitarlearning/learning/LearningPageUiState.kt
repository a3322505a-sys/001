...
data class RegionUi(val id: String, val title: String, val progress: String, val rows: List<NodeRowUi>, val practiceIds: List<String>, val note: String? = null)
...
data class NodeDetailUiState(val row: NodeRowUi, val description: String, val startLabel: String?, val canPractice: Boolean, val panels: List<InfoPanelUi>, val recordLines: List<String>)
